...
<head>
    ...
    <title>abroad-dashboard</title>
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="format-detection" content="abroad">
    <!-- MOBILE SPECIFIC -->

    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    {{-- <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests; default-src https:; img-src https: data:; script-src https: 'unsafe-inline' 'unsafe-eval'; style-src https: 'unsafe-inline';"> --}}
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="{{ url('/admin/dashboard') }}" class="brand-logo">
                ...
                <img class="brand-title" src="{{ asset('admin/assets/images/logo.png') }}" alt="/">
            </a>
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="media me-2">
                                                        <img alt="image" width="50"
                                                            src="{{ asset('admin/assets/images/avatar/1.jpg') }}">
                                                    </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button"
                                    ...
                                    <div class="header-info">
                                        <span
                                            class="text-black">{{ ucfirst(Auth::user()->first_name . ' ' . Auth::user()->last_name) }}</span>
                                        <p class="fs-12 mb-0">{{ ucfirst(Auth::user()->first_name) }}</p>
                                    </div>
                                    <img src="{{ asset('admin/assets/images/profile/17.jpg') }}" width="20"
                                        alt="/">
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{ url('/admin/admin-profile') }}" class="dropdown-item ai-icon">
