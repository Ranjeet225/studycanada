    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="mb-3">
                    <a href="{{route('create.country.university')}}"
                        class="btn btn-primary btn-sm">Add About Country University</a>
                </div>
                <div class="filter cm-content-box box-primary">
                    <div class="content-title SlideToolHeader">
                        <div class="cpa">
                            <i class="fa-solid fa-file-lines me-1"></i>Country University List
                        </div>
                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                    ...
                                    <nav aria-label="Page navigation example mb-2">
                                        <ul class="pagination mb-2 mb-sm-0">
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $countryuniversity->previousPageUrl() }}">
                                                    <i class="fa-solid fa-angle-left"></i>
                                                </a>
                                            </li>

                                            <!-- Display each page link -->
                                            @for ($i = 1; $i <= $countryuniversity->lastPage(); $i++)
                                                <li class="page-item {{ $countryuniversity->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link"
                                                        href="{{ $countryuniversity->url($i) }}">{{ $i }}</a>
                                                </li>
                                            @endfor

                                            <li class="page-item">
                                                <a class="page-link" href="{{ $countryuniversity->nextPageUrl() }}">
