...
<div class="nav-header">
    <a href="{{url('/vendor/dashboard')}}" class="brand-logo">
					...
					<li class="nav-item dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<div class="header-info">
								<span class="text-black">{{ucfirst(Auth::user()->first_name.' '.Auth::user()->last_name)}}</span>
								<p class="fs-12 mb-0">{{ucfirst(Auth::user()->first_name)}}</p>
							</div>
							<img src="{{asset('admin/assets/images/profile/17.jpg')}}" width="20" alt="/">
						</a>
						<div class="dropdown-menu dropdown-menu-end">
							<a href="{{url('/vendor/profile')}}" class="dropdown-item ai-icon">
